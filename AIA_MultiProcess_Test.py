...
def Add_Earth(FILE):
	...
	earth_g = earth_g.set_duration(earthvideo_length).fl_time(lambda t: speedmult*t).set_pos((0.1, 0.8), relative = True).resize(0.0242) # to account for the downsized resolution of our template video. Current Earth size = 388 pixels
