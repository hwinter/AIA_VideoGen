...
#Actually run ffmpeg
    ...
    def python_ffmpeg(self):
        ...
        command = command+'-profile main -qdiff 4 -qcomp 0.7 -direct-pred 3 -flags +loop+mv4 '
        ...
        command = command+'-b_strategy 1 -bidir_refine 1 -refs 6 -trellis 1 '
